...
def get_menu_plan():
    ...
    if request.method == 'POST':
        ...
        caloric_needs_input = request.form.get('caloricNeeds', '0') 
        try:
...
BREAKFAST_FOODS = [ 'cereal', 'oatmeal', 'yogurt']
LUNCH_FOODS = ['sandwich', 'salad', 'soup']
DINNER_FOODS = ['pasta', 'vegetables', 'rice', 'meat']
